  ...
  return (
    <section id="vertrauen" className="relative py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-8 sm:px-12 md:px-16 lg:px-20">
        ...
        {/* Logo image - full width, parallax */}
        <div ref={logoRef} className="mt-8 relative rounded-2xl overflow-hidden">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-midnight/80 via-midnight/40 to-transparent rounded-2xl" />
            <div className="absolute inset-0 bg-gradient-to-t from-midnight/60 via-transparent to-midnight/20 rounded-2xl" />

            {/* Text overlay with parallax */}
            <motion.div
              className="absolute bottom-0 left-0 p-8 md:p-12 lg:p-16 max-w-lg"
              style={{ y: textY }}
            >
              <motion.span
              ...
              <motion.h3
                className="text-2xl md:text-3xl lg:text-4xl font-serif font-semibold mt-3 mb-4 text-text-primary"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
